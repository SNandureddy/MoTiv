...
enum DateFormat: String {
    ...
    case date12HourTime = "MM-dd-yyyy h:mm a"
    ...
    case weekDate = "EEEE, dd MMMM"
    case time = "h:mm a"
    case longTime = "HH:mm:ss"
    case longTime12 = "hh:mm:ss"
    case weekDay = "EEEE"
    case motivDateTime = "MMM dd, yyyy hh:mm a"
}
...
extension Date {
    ...
    func stringFromDate(format: DateFormat, type: TimeZoneType) -> String {
        ...
        if type == .utc {
            ...
            dateFormatter.timeZone = TimeZone(abbreviation: "GMTE")
    ...
    func addYearsInDate(years:Int) -> Date {
        let calendar = Calendar.current
